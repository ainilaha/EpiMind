...
The BIA examination was administered to eligible survey participants 8-49
...
English Text:
    ...
    Resistance (ohms) of extracellular fluid (ECF) from Cole modeling
Target:
...
English Text:
    ...
    Time delay (ns) from Cole modeling 
Target:
