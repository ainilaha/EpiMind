...
Code or Value | Value Description | Count | Cumulative | Skip to Item  
---|---|---|---|---  
1 | Doctor said nerves causing attacks | 6 | 6 |   
77 | Refused | 1 | 7 |   
99 | Don't know | 3 | 10 |   
. | Missing | 918 | 928 |   
...
Code or Value | Value Description | Count | Cumulative | Skip to Item  
---|---|---|---|---  
2 | Doctor said stress causing attacks | 13 | 13 |   
. | Missing | 915 | 928 |   
...
SAS Label:
    ...
    Doctor said anxiety causing attacks
English Text:
...
Code or Value | Value Description | Count | Cumulative | Skip to Item  
---|---|---|---|---  
3 | Doctor said anxiety causing attacks | 21 | 21 |   
. | Missing | 907 | 928 |   
...
SAS Label:
    ...
    Doctor said depression causing attacks
English Text:
...
Code or Value | Value Description | Count | Cumulative | Skip to Item  
---|---|---|---|---  
4 | Doctor said depression causing attacks | 9 | 9 |   
. | Missing | 919 | 928 |   
...
SAS Label:
    ...
    Doc said mental illness causing attacks
English Text:
...
Code or Value | Value Description | Count | Cumulative | Skip to Item  
---|---|---|---|---  
5 | Doc said mental illness causing attacks | 2 | 2 |   
. | Missing | 926 | 928 |   
...
SAS Label:
    ...
    Doctor said medication causing attacks
English Text:
...
Code or Value | Value Description | Count | Cumulative | Skip to Item  
---|---|---|---|---  
6 | Doctor said medication causing attacks | 1 | 1 |   
. | Missing | 927 | 928 |   
...
SAS Label:
    ...
    Doctor said drugs causing attacks
English Text:
...
Code or Value | Value Description | Count | Cumulative | Skip to Item  
---|---|---|---|---  
7 | Doctor said drugs causing attacks | 0 | 0 |   
. | Missing | 928 | 928 |   
...
SAS Label:
    ...
    Doctor said alcohol causing attacks
English Text:
...
Code or Value | Value Description | Count | Cumulative | Skip to Item  
---|---|---|---|---  
8 | Doctor said alcohol causing attacks | 0 | 0 |   
. | Missing | 928 | 928 |   
...
SAS Label:
    ...
    Doctor said phys illness causing attacks
English Text:
...
Code or Value | Value Description | Count | Cumulative | Skip to Item  
---|---|---|---|---  
9 | Doctor said phys illness causing attacks | 1 | 1 |   
. | Missing | 927 | 928 |   
...
SAS Label:
    ...
    Doctor said phys injury causing attacks
English Text:
...
Code or Value | Value Description | Count | Cumulative | Skip to Item  
---|---|---|---|---  
10 | Doctor said phys injury causing attacks | 0 | 0 |   
. | Missing | 928 | 928 |   
...
SAS Label:
    ...
    Doctor gave no definite diag for attacks
English Text:

    Doctor gave no definite diagnosis for attacks
English Instructions:
...
Code or Value | Value Description | Count | Cumulative | Skip to Item  
---|---|---|---|---  
11 | Doctor gave no definite diagnosis for attacks | 4 | 4 |   
. | Missing | 924 | 928 |   
...
English Text:
    ...
    When attacks were not result of medicine, drugs, or alcohol, were attacks result of physical illness?
English Instructions:

     (Collection name = D58APD4)
Target:
...
1 | Yes | 1 | 1 | CIDPPRB   
2 | No | 0 | 1 | CIDPPRB   
7 | Refused | 0 | 1 | CIDPPRB   
9 | Don't know | 0 | 1 | CIDPPRB   
. | Missing | 927 | 928 |   
...
SAS Label:
    ...
    Anything abnormal when exam?
English Text:

    Anything abnormal when exam?
English Instructions:

    (Collection name = D58APD10)
Target:

     Both males and females 20 YEARS - 39 YEARS
Code or Value | Value Description | Count | Cumulative | Skip to Item  
---|---|---|---|---  
1 | Nothing abnormal | 5 | 5 | CIDPPRB   
2 | No examination | 2 | 7 | CIDPPRB   
3 | Something abnormal | 1 | 8 |   
7 | Refused | 0 | 8 | CIDPPRB   
9 | Don't know | 0 | 8 | CIDPPRB   
. | Missing | 920 | 928 |   
...
SAS Label:
    ...
    Were attacks always result phys ill?
English Text:

    Were attacks always result of physical illness?
English Instructions:

     (Collection name = D58APD7)
Target:
...
English Text:
    ...
    When attacks were not due to physical illness, were attacks always result of medicine, drugs, or alcohol?
English Instructions:

     (Collection name = D58APD8)
Target:
...
SAS Label:
    ...
    General cause of problem
English Text:

    General cause of problem
English Instructions:

     (Collection name = D58APRB)
Target:
...
---|---|---|---|---  
1 | No Problem | 0 | 0 |   
2 | Not clinically significant | 27 | 27 |   
3 | Medication, Drugs, or Alcohol | 0 | 27 |   
4 | Physical cause | 3 | 30 |   
5 | Psychiatric Symptom | 41 | 71 |   
. | Missing | 857 | 928 |   
...
English Text:
    ...
    About how many days in the past 12 months were you totally unable for the whole day to work and carry out your other normal activities because of these problems? You can answer with any number between 0 and 365.
English Instructions:

     (Collection name = D62A)
Target:

     Both males and females 20 YEARS - 39 YEARS
Code or Value | Value Description | Count | Cumulative | Skip to Item  
---|---|---|---|---  
0 to 365 | Range of Values | 56 | 56 |   
777 | Refused | 0 | 56 |   
999 | Don't know | 0 | 56 |   
. | Missing | 872 | 928 |   
...
English Instructions:
    ...
    IF CIQP60 = 0 GO TO CIQP63. IF CIQP60 = 1, GO TO CIQP61. ELSE GO TO CIQP62
Target:
...
SAS Label:
    ...
    Did totally occur past 4 weeks?
English Text:

    Did that day occur in the past four weeks?
English Instructions:

     (Collection name = D62A_1)
Target:
...
English Text:
    ...
    How many of these (# FROM CIQP60) days were in the past four weeks?
English Instructions:

     (Collection name = D62A_2)
Target:

     Both males and females 20 YEARS - 39 YEARS
Code or Value | Value Description | Count | Cumulative | Skip to Item  
---|---|---|---|---  
0 to 28 | Range of Values | 16 | 16 |   
77 | Refused | 0 | 16 |   
99 | Don't know | 0 | 16 |   
. | Missing | 912 | 928 |   
...
English Text:
    ...
    [Not counting the day(s) you were totally unable to work,] about how many (other) days in the past 12 months did you cut back either on the amount of work you got done or on the quality of your work because of the problems associated with attacks? (Again, you can use any number between 0 and 365.)
English Instructions:

     (Collection name = D62B)
Target:

     Both males and females 20 YEARS - 39 YEARS
Code or Value | Value Description | Count | Cumulative | Skip to Item  
---|---|---|---|---  
0 to 190 | Range of Values | 54 | 54 |   
777 | Refused | 0 | 54 |   
999 | Don't know | 0 | 54 |   
. | Missing | 874 | 928 |   
...
English Instructions:
    ...
    IF CIQP63 = 0, GO TO CIQP67. ELSE GO TO CIQP64.
Target:
...
English Instructions:
    ...
    IF CIQP63 = 1, GO TO CIQP65. ELSE GO TO CIQP66
Target:
...
1 | Yes | 0 | 0 | CIQP67   
2 | No | 0 | 0 | CIQP67   
7 | Refused | 0 | 0 | CIQP67   
9 | Don't know | 0 | 0 | CIQP67   
. | Missing | 928 | 928 |   
...
English Text:
    ...
    How many of these (# FROM CIQP63) cutback days occurred in the past four weeks?
English Instructions:

     (Collection name = D62C_2)
Target:

     Both males and females 20 YEARS - 39 YEARS
Code or Value | Value Description | Count | Cumulative | Skip to Item  
---|---|---|---|---  
0 to 10 | Range of Values | 13 | 13 |   
77 | Refused | 0 | 13 |   
99 | Don't know | 0 | 13 |   
. | Missing | 915 | 928 |   
...
English Text:
    ...
    . [Not counting the day(s) (you were totally unable to work)/(or)/(you cut back on work),] about how many (other) days in the past 12 months did it take an extreme effort to perform up to your usual level at work or at your other normal daily activities because of problems associated with attacks? (Again, you can use any number between 0 and 365.)
English Instructions:

     (Collection name = D62C_3)
Target:

     Both males and females 20 YEARS - 39 YEARS
Code or Value | Value Description | Count | Cumulative | Skip to Item  
---|---|---|---|---  
0 to 350 | Range of Values | 52 | 52 |   
777 | Refused | 0 | 52 |   
999 | Don't know | 1 | 53 |   
. | Missing | 875 | 928 |   
...
English Instructions:
    ...
    IF CIQP67 = 0 GO TO CIQP70. IF CIQP67 = 1, GO TO CIQP68. ELSE GO TO CIQP69
Target:
...
English Text:
    ...
    How many of these (# FROM CIQP67) days occurred in the past four weeks?
English Instructions:

     (Collection name = D62C_3_2)
Target:

     Both males and females 20 YEARS - 39 YEARS
Code or Value | Value Description | Count | Cumulative | Skip to Item  
---|---|---|---|---  
0 to 10 | Range of Values | 12 | 12 |   
77 | Refused | 0 | 12 |   
99 | Don't know | 0 | 12 |   
. | Missing | 916 | 928 |   
...
English Text:
    ...
    And about how many days in the past 12 months did these problems seriously interfere with your personal or social life? (Again, you can use any number between 0 and 365.)
English Instructions:

     (Collection name = D62D)
Target:

     Both males and females 20 YEARS - 39 YEARS
Code or Value | Value Description | Count | Cumulative | Skip to Item  
---|---|---|---|---  
0 to 365 | Range of Values | 55 | 55 |   
777 | Refused | 0 | 55 |   
999 | Don't know | 1 | 56 |   
. | Missing | 872 | 928 |   
...
English Instructions:
    ...
    IF CIQP70 = 0, GO TO GAD SECTION. IFCIQP70 = 1, GO TO CIQP71. ELSE GO TO CIQP72
Target:
...
English Text:
    ...
    How many of these (# FROM CIQP70) days occurred in the past four weeks?
English Instructions:

     (Collection name = D62D_2)
Target:

     Both males and females 20 YEARS - 39 YEARS
Code or Value | Value Description | Count | Cumulative | Skip to Item  
---|---|---|---|---  
0 to 28 | Range of Values | 31 | 31 |   
77 | Refused | 0 | 31 |   
99 | Don't know | 1 | 32 |   
. | Missing | 896 | 928 |   
...
and CIQP15 in(1,2) and CIQP12^=2 and 1<CIQP32<7777  
