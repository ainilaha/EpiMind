...
exposure. Contact with nickel can cause allergic skin reactions; inhalation of
nickel has been found to lead to asthma, chronic bronchitis, and lung cancer;
drinking water containing high levels of nickel has been found to cause
stomach, blood, and kidney issues.
...
This method (Jones, 2021) directly measures the nickel, arsenic, and chromium
...
according to their mass-to-charge (m/z) ratio. When detecting nickel, the UCT
is filled with helium gas and operated in a kinetic energy discrimination
(KED) mode to eliminate polyatomic interferences. Quantification of nickel is
accomplished by comparing the blank-subtracted counting rate of nickel from a
...
Code or Value | Value Description | Count | Cumulative | Skip to Item  
---|---|---|---|---  
0.22 to 64.12 | Range of Values | 4569 | 4569 |   
. | Missing | 321 | 4890 |   
...
Code or Value | Value Description | Count | Cumulative | Skip to Item  
---|---|---|---|---  
0 | At or above detection limit | 4267 | 4267 |   
1 | below lower detection limit | 302 | 4569 |   
. | Missing | 321 | 4890 | 
