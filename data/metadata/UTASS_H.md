...
### Arsenic - Total - Urine - Special Sample (UTASS_H)

####  Data File: UTASS_H.xpt
...
(Neubauer K. et al., 1999 and Jarrett, J.M et al., 2007). Urine samples are
...
## References
  ...
  * J.M. Jarrett, R.L. Jones, K.L. Caldwell, and C.P. Verdon, Total urine arsenic measurements using inductively coupled plasma mass spectrometry with a dynamic reaction cell. Atomic Spectroscopy, 2007. 28(4): p. 113-122.
...
Code or Value | Value Description | Count | Cumulative | Skip to Item  
---|---|---|---|---  
0.28 to 903.84 | Range of Values | 2525 | 2525 |   
. | Missing | 80 | 2605 |   
...
1 | Below lower detection limit | 0 | 2525 |   
. | Missing | 80 | 2605 |   
